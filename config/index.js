...
const config = {
  ...
  external: {
    nseDataSourceUrl: process.env.NSE_DATA_SOURCE_URL || 'https://afx.kwayisi.org/nse/',
  },
  logging: {
  ...
  docs: {
    ...
    description: process.env.API_DESCRIPTION || 'A fast and reliable API for scraping Nairobi Securities Exchange stock prices',
  },
};
